...
from qiskit.algorithms.state_fidelities import StateFidelityResult



class ComputeUncompute_2(BaseStateFidelity):
    r"""
    ...
    **Reference:**
    ...
    def transpile_circuit(self, 
        ...
        r"""
        Transpile the input circuit using the pass manager.
        """
    ...
    def _run(
        ...
        **options,
        ...
        # transpile circuits using the pass manager
